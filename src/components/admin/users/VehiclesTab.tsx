      ...
      <Card className="bg-white border-gray-100 shadow-sm flex flex-col h-full overflow-hidden rounded-2xl">
        <CardHeader className="pb-3 border-b border-gray-50 bg-gray-50/50">
          ...
          <div className="relative mt-2">
            ...
            <Input
              ...
              className="pl-10 bg-white border-gray-200 text-gray-900 focus:ring-blue-500/20 rounded-xl"
              value={searchTerm}
        ...
        <CardContent className="flex-1 p-0 flex flex-col overflow-hidden">
            ...
            {isLoading ? (
              ...
              <div className="space-y-2 mt-2">
                {availableVehicles.map((v) => (
                  <div key={v.id_rastremix} className="flex items-center justify-between p-3 rounded-xl bg-gray-50 border border-gray-100 hover:border-blue-200 hover:bg-blue-50 transition-all group">
                    ...
                    <Button
                      variant="ghost"
                      size="icon"
                      className="text-gray-400 hover:text-blue-600 hover:bg-blue-100 rounded-xl transition-colors"
          ...
          <div className="p-4 border-t border-gray-50 flex justify-center gap-2 bg-gray-50/50">
            <Button variant="outline" size="sm" className="hidden md:flex bg-white border-gray-200 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-xl px-4" onClick={handleAddAll}>
