    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 select-none">
      <div className="text-center p-12 bg-white rounded-[3rem] shadow-2xl border border-gray-100 max-w-lg w-full mx-4 animate-in fade-in zoom-in duration-500">
        ...
        <p className="mb-10 text-gray-400 font-medium leading-relaxed">
          Ocorreu um erro ao tentar acessar o recurso em <code className="px-2 py-1 bg-gray-100 rounded text-blue-600 text-xs font-bold">{location.pathname}</code>. 
          Certifique-se de que o endereço está correto ou retorne ao portal.
        </p>
        <a 
          href="/" 
          className="inline-flex h-14 items-center px-10 bg-blue-600 text-white font-black rounded-2xl shadow-xl shadow-blue-100 hover:bg-blue-700 transition-all hover:scale-105 active:scale-95 uppercase tracking-widest text-xs"
        >
          Voltar ao Início
        </a>
      </div>
